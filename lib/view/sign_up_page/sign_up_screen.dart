...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: AppText(text: AppString.signupTitle, fontWeight: FontWeight.bold, fontSize: height / 40),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              AppTextFormField(controller: dateOfBirthController, labelText: AppString.labelTextOfDateOfBirth, hintText: AppString.hintTextOfDateOfBirth, validator: (value) => utils.isValidDateOfBirth(dateOfBirthController.text) ? null : AppString.errorNumberTitle, keyboardType: TextInputType.name),
              SizedBox(
                height: height / 10,
              ),
              AppElevatedButton(
